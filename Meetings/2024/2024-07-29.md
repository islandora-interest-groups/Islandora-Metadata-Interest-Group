...
* Use of paragraphs for title and/or contributor
* e.g. text field for contributor with optional link
* Metadata fatigue is a real thing.
* Some work involved in making work correctly (see twig templates)
* Can't have multi-typed fields. 
* Use of linked data seen as desirable
* Where are you in migration/use of islandora?
