...
### Agenda:
* Announcements
* Review of simplified mapping proposal
* Possible: discuss the best way to split up verification that MIG documentation and yamel mapping and Islandora Defaults (possibly need to rename?) all match
